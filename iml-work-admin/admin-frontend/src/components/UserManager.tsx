          ...
          <div className="skill-drawer" style={{ width: 520 }} onClick={e => e.stopPropagation()}>
            ...
            <div className="form-group">
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {roles.map(r => (
                  <label key={r.name} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, padding: '4px 10px', border: '1px solid var(--border-color)', borderRadius: 999, cursor: 'pointer', background: form.roles.includes(r.name) ? 'var(--mint-50, rgba(26,80,217,0.12))' : 'transparent' }}>
            ...
            <div className="form-group">
              ...
              {!form.allowAllExperts && (
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 6 }}>
                  {experts.map(ex => (
                    <label key={ex.id} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, padding: '4px 10px', border: '1px solid var(--border-color)', borderRadius: 6, cursor: 'pointer', background: form.assignedExpertIds.includes(ex.id) ? 'var(--mint-50, rgba(26,80,217,0.12))' : 'transparent' }}>
