...
普通 AI 工具停在「聊天」，iML Work 的分身能在真实企业系统里动手。支撑它的是三条主线——**听懂业务语义、接得上存量系统、动手前过得了闸**。三条主线各自怎么实现，见下文[怎么做到的](#怎么做到的)。
...
<img src="assets/screenshots/04-skills.png" alt="技能中心" width="100%">
