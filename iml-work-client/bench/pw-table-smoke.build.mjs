...
await build({
  entryPoints: [path.join(BENCH, 'pw-table-smoke.ts')],
  bundle: true,
  platform: 'node',
  format: 'cjs',
  target: 'node20',
  outfile: path.join(CLIENT, 'node_modules/.bench/pw-table-smoke.cjs'),
...
console.log('pw-table-smoke bundle OK → node_modules/.bench/pw-table-smoke.cjs')
