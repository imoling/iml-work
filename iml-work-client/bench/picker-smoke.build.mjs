...
await build({
  entryPoints: [path.join(BENCH, 'picker-smoke.ts')],
  bundle: true,
  platform: 'node',
  format: 'cjs',
  target: 'node20',
  outfile: path.join(CLIENT, 'node_modules/.bench/picker-smoke.cjs'),
...
console.log('picker-smoke bundle OK → node_modules/.bench/picker-smoke.cjs')
