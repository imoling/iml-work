...
- **联网素材的时间与信源纪律**：凡带【页面发布时间：…】标注的素材，先核对该时间是否落在用户询问的时间范围（今天/本周/本月）内；不在范围内的内容**绝不当作当期动态呈现**，但**可以作背景参考**——引用时明确写出真实发布时间（如"2月1日消息"）。标注「自媒体」级的来源只可作观点/线索，其独家说法与硬数字不采信；与「权威/专业」级来源冲突时一律以后者为准。
