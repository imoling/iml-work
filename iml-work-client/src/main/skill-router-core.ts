...
// 「技能」必须是**宾语收尾**（后面只能是语气尾缀/标点/句尾）——否则「技能培训体系的通知」
// 「技能矩阵表」「技能考核方案」这类 HR/培训岗日常措辞会被整句劫进技能创建流（体检 P1-6，node 实测）。
