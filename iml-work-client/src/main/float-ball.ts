...
<svg id="m" viewBox="0 0 240 240" width="104" height="124" preserveAspectRatio="xMidYMax meet" fill="none">
 <defs>
  <radialGradient id="rgb" cx="0.35" cy="0.25" r="0.95"><stop offset="0" stop-color="#93F2CA"/><stop offset="0.5" stop-color="#43D398"/><stop offset="1" stop-color="#1FA475"/></radialGradient>
  <radialGradient id="rgl" cx="0.35" cy="0.3" r="1"><stop offset="0" stop-color="#52D9A2"/><stop offset="1" stop-color="#1C9A6C"/></radialGradient>
  <radialGradient id="rgf" cx="0.4" cy="0.3" r="1"><stop offset="0" stop-color="#2BB782"/><stop offset="1" stop-color="#14805A"/></radialGradient>
 ...
 <g id="jelly">
  <path id="echo" d="M120 44C158 44 186 58 188 96C190 128 190 158 184 176C176 200 152 206 120 206C88 206 64 200 56 176C50 158 50 128 52 96C54 58 82 44 120 44Z" transform="translate(-18 -16)" stroke="#3B82F6" stroke-width="8" stroke-linecap="round" stroke-dasharray="16 18"/>
  <g id="antenna"><path d="M122 46Q120 30 130 22" stroke="#1FA475" stroke-width="6" stroke-linecap="round"/><circle cx="133" cy="19" r="8" fill="#3B82F6"/><circle cx="130.5" cy="16.5" r="2.5" fill="#FFFFFF"/></g>
  ...
  <g id="sweat"><path d="M176 72C184 84 184 96 176 99C168 96 168 84 176 72Z" fill="#3B82F6"/></g>
  <g id="eyesN">
