...
//
// 术语与模块贴合炼化行业通用作业流程：装置、生产指令、作业票、隐患排查、平稳率、报警。
...
const seedDb = () => ({
  ...
  hazards: [
    ...
    { id: 'YH-2026-0471', unit: '罐区', place: '5#原油罐北侧', desc: '消防泡沫管线保温层破损。', level: 'low', reporter: '王师傅', foundAt: '2026-07-10', state: '已验证' },
  ],
  // 装置运行数据：查询/监控类
  units: [
